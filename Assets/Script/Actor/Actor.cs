...
public class Actor : MonoBehaviour
{
    ...
    {       
        ...
        OnWhiteFlash(rendererList, emission_propertyNameID);

        yield return new WaitForSeconds(0.1f);

        OffWhiteFlash(rendererList, emissionList, emission_propertyNameID);
    ...
    void OnWhiteFlash(List<Renderer> rendererList, int emission_propertyNameID)
    {
    ...
    void OffWhiteFlash(List<Renderer> rendererList, List<Vector4> emissionList, int emission_propertyNameID)
    {
        for (int i = 0; i < rendererList.Count; i++)
        {
